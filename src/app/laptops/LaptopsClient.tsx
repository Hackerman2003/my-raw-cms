...
const priceRanges = [
  ...
  { label: "Under 1,500,000 TZS", value: "0-1500000" },
  { label: "1,500,000 - 3,000,000 TZS", value: "1500000-3000000" },
  { label: "Over 3,000,000 TZS", value: "3000000-100000000" },
];
...
export function LaptopsClient({ initialLaptops }: LaptopsClientProps) {
  ...
  const filteredLaptops = useMemo(() => {
    return initialLaptops.filter((laptop: Laptop) => {
      // Stock status filter
      if (
